...
outputDocument.close();
          ...
          function updateLabel() {
            if (document.getElementById('html-input').value !== "") {
              ...
              document.getElementById('changeai').placeholder = "Make me a webpage for... "
...
function aiproject() {
  ...
  var aiinput = "I want the full code only!! I need the full html css and js code to create a website where " + document.getElementById('changeai').value + " I need the full html css and js code for this webpage. Don't add any images divide the code by ```html ```css ```javascript and only give me the code in the response";
...
var qrcode = new QRCode("outputshare", {
  text: "https://www.div-idy.com/view.html?v=" + projecturl,
...
if (toggleText.textContent == "Public"){
  ...
  var link = "https://www.div-idy.com/view.html?v=" + projecturl;


  document.getElementById("outputshare").innerHTML = "<a href='" + link + "'>" + link + "</a>";
  document.getElementById("outputshare").innerHTML += "<p style='text-align: center'; >Copied!!</p>";
